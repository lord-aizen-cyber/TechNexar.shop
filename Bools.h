...
void *myPlayer = NULL;
bool aimskill;
ImColor Esp_Box = ImColor(255, 255, 255, 255);
ImColor Esp_Grad1 = ImColor(255, 255, 255, 255);
ImColor Esp_Grad2 = ImColor(255, 255, 255, 255);
ImColor Esp_3DBox = ImColor(255, 255, 255, 255);
ImColor Esp_Fled = ImColor(255,255,255,150);
ImColor Esp_Text = ImColor(255, 255, 255, 255);
ImColor Esp_Dist = ImColor(255, 255, 255, 255);
...
float Fov_Aim = 50.0f;  // Set default FOV value
float Aimdis = 1000.0f;  // Set default distance value
bool Aimbot = true;  // AIMBOT DIAKTIFKAN SECARA DEFAULT
